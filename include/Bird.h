...
public:
	...
	Bird(int entityId, b2World* world, b2BodyDef* bodyDef, b2FixtureDef* materialDef, BirdType type, float size) : DynamicObject(entityId, world, new sf::CircleShape(size), bodyDef, materialDef) {
